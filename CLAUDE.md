...
- **요약**: 월누적 + 일평균 + 전월비
- **전체 표** (T1·T2 × 월누적·일평균)
- **일자별 차트**: T1·T2 분리, 이번달 실선 + 전월 점선 + 전월 평균 가로선 + Today 수직선(슬레이트 톤으로 통일) + 주말·공휴일 빨강
- **일자별 표**: 행=일자, 컬럼=`날짜·요일·T1[전월·이번달·전월동요일비]·T2[전월·이번달·전월동요일비]`. 오늘 ~ 월말 노란 배경(`future-row`), 토·일·공휴일 빨강
  - **전월동요일비**: 같은 요일 평균 대비 비율 (예: 4월 7일=월 → 3월 모든 월요일 평균과 비교)
- **항공사별·도착지별·탑승구별 표** (T1·T2 그룹)
- **각주**: 탑승구 분류 / 집계 제외 기준 / 데이터 출처
