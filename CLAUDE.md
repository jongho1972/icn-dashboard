...
- **요약**: 월누적 + 일평균 + 전월비
- **전체 표** (T1·T2 × 월누적·일평균)
- **일자별 차트**: T1·T2 분리, 이번달 실선 + 전월 점선 + 전월 평균 가로선 + Today 수직선 + 주말·공휴일 빨강
- **일자별 표 (전치형)**: 일자가 컬럼, 좌측 라벨 일자/요일/T1/T2 (T1·T2는 편수+전월동요일비 2행을 rowspan으로 묶음). 오늘 ~ 월말 노란 배경. 제목 "전월 동일요일 대비"
